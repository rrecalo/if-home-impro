  ...
  return (
    <div id="homepage" className='pt-[80px] pb-[0px]'>
        ...
        <div id="quality_content" className='flex flex-row w-[100%] mt-[100px] justify-center'>
            <div className='flex flex-col bg-stone-100 col-sp items-center justify-center w-[50%] border-black border border-r-0'>
            ...
            <div id="kitchen_img" className='flex bg-stone-100 h-24 w-[50%] border-black border'
            style={{backgroundImage: `url(${kitchen_img})`}}>
            </div>
        </div>

        <div id="xp_content" className='flex flex-row  mt-[100px] justify-center'>
        
            <div id="xp_img" className='flex bg-stone-100 h-24 w-[100%] border-black border justify-center'
            style={{backgroundImage: `url(${xp_bg})`}}>
                <div className='flex flex-col w-[90%] justify-center text-left ml-[5%]'>
                    <div id="xp_header" className='text-8xl'>
                    With <span className='font-bold'>20 years</span> of experience, our expertise is <span className='font-bold'>unmatched.</span>
                    </div>
                    <div className='light_txt mt-4 ml-2 text-4xl'>
        ...
        <div id="quality_content" className='flex flex-row w-[100%] mt-[100px] justify-center'>
            ...
            <div className='flex flex-col bg-stone-100 col-sp items-center justify-center w-[50%] border-black border border-l-0'>
                <div className='w-[90%] text-left'>
                    ...
                    <button id='cta_btn' className='bg-black text-white mt-8 h-12 w-[25%] text-2xl'>
                        Contact Us
                    </button>
                </div>
            </div>
